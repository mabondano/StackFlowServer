...
import com.merlab.stackflow.api.dto.SignalDTO;
import com.merlab.stackflow.persistence.entity.Signals;

public class SignalMapper {

    public static SignalDTO toDTO(Signals entity) {
    ...
    public static Signals toEntity(SignalDTO dto) {
        if (dto == null) return null;

        Signals entity = new Signals();
        // TODO: mapear atributos reales
        return entity;
    }

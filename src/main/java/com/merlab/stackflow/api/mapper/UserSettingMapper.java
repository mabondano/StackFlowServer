...
import com.merlab.stackflow.api.dto.UserSettingDTO;
import com.merlab.stackflow.persistence.entity.UserSettings;

public class UserSettingMapper {

    public static UserSettingDTO toDTO(UserSettings entity) {
    ...
    public static UserSettings toEntity(UserSettingDTO dto) {
